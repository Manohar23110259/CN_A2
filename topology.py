...
def create_topology():
    ...
    info('*** Adding hosts\n')
    # Add hosts and set defaultRoute to None (we will set it manually)
    ...
    # --- NEW PART FOR INTERNET ACCESS ---
    info('*** Adding NAT for internet connectivity\n')
    # Add a NAT node and connect it to S1.
    # This node will bridge Mininet to your VM's internet.
    ...
    # --- NEW PART FOR ROUTING ---
    info('*** Setting default routes for hosts\n')
    # Tell all hosts to send internet-bound packets to the NAT node
    ...
    # The custom DNS resolver will also need internet access for Task D
